...
#define UTEST_EXPECT(x, y, cond)                                                                                       \
    ...
    {                                                                                                                  \
        ...
        if (!((xEval)cond(yEval)))                                                                                     \
        {                                                                                                              \
            _Pragma("clang diagnostic pop") UTEST_PRINTF("%s:%u: Failure\n", __FILE__, __LINE__);                      \
...
#define EXPECT_NEAR(x, y, epsilon)                                                                                     \
    UTEST_SURPRESS_WARNING_BEGIN do                                                                                    \
    {                                                                                                                  \
        if (utest_fabs(UTEST_CAST(double, x) - UTEST_CAST(double, y)) > UTEST_CAST(double, epsilon))                   \
        {                                                                                                              \
            UTEST_PRINTF("%s:%u: Failure\n", __FILE__, __LINE__);                                                      \
...
#define UTEST(SET, NAME)                                                                                                    \
    ...
    {                                                                                                                       \
        ...
        utest_state.tests      = UTEST_PTR_CAST(                                                                            \
                 struct utest_test_state_s *, utest_realloc(UTEST_PTR_CAST(void *, utest_state.tests),                      \
...
int utest_main(int argc, const char *const argv[])
{
    ...
    for (index = 0; index < utest_state.tests_length; index++)
    {
        ...
        if (UTEST_TEST_FAILURE == result)
        {
            ...
            failed_testcases = UTEST_PTR_CAST(size_t *, utest_realloc(UTEST_PTR_CAST(void *, failed_testcases),
        ...
        else if (UTEST_TEST_SKIPPED == result)
        {
            ...
            skipped_testcases = UTEST_PTR_CAST(size_t *, utest_realloc(UTEST_PTR_CAST(void *, skipped_testcases),
